...
export class SessionsQueryDto {
  ...
  @ApiProperty({ required: false, description: 'Filter sessions since this date (ISO 8601)' })
  @IsOptional()
  @IsDateString()
  since?: string;

  @ApiProperty({ required: false, description: 'Filter sessions until this date (ISO 8601)' })
  @IsOptional()
  @IsDateString()
  until?: string;
  ...
  @ApiProperty({ required: false, enum: ['startedAt', 'duration'], default: 'startedAt' })
  @IsOptional()
