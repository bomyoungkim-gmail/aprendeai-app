...
export class ConfigFilterDto {
  ...
  @ApiPropertyOptional({ description: 'Filter by environment', enum: Environment })
  @IsOptional()
  @IsEnum(Environment)
...
export class CreateConfigDto {
  @ApiProperty({ description: 'Config key (unique)', example: 'openai.api_key' })
  @IsString()
  key: string;
  ...
  @ApiPropertyOptional({ description: 'Environment (null = all)', enum: Environment })
  @IsOptional()
  @IsEnum(Environment)
  environment?: Environment;
