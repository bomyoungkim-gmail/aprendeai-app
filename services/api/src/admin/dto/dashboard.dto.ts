import { IsDateString, IsEnum, IsOptional, IsString, IsBoolean, IsInt, Min } from 'class-validator';
...
export class MetricsQueryDto {
  ...
  @ApiProperty({ description: 'Start date (ISO string)', example: '2024-01-01T00:00:00Z' })
  @IsDateString()
  from: string;

  @ApiProperty({ description: 'End date (ISO string)', example: '2024-01-02T00:00:00Z' })
  @IsDateString()
  to: string;

  @ApiProperty({ description: 'Time bucket', enum: ['1m', '1h', '1d'], example: '1h' })
  @IsEnum(['1m', '1h', '1d'])
  bucket: string;
}
