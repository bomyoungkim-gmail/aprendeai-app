...
export const ROUTES = {
  ...
  AUTH: {
    ...
    EXTENSION_GRANTS_REVOKE: (grantId: string) =>
      `auth/extension/grants/${grantId}/revoke`,
  ...
  FAMILY: {
    ...
    REMOVE_MEMBER: (id: string, memberUserId: string) =>
      `families/${id}/members/${memberUserId}`,
    ...
    POLICY_GET: (familyId: string, learnerId: string) =>
      `families/policy/${familyId}/${learnerId}`,
    ...
    EDUCATOR_DASHBOARD: (familyId: string, learnerId: string) =>
      `families/${familyId}/educator-dashboard/${learnerId}`,
  ...
  CLASSROOM: {
    ...
    INTERVENTIONS_PROMPT: (id: string) =>
      `classrooms/${id}/interventions/prompt`,
  ...
  INSTITUTIONS: {
    ...
    CANCEL_INVITE: (id: string, inviteId: string) =>
      `institutions/${id}/invites/${inviteId}`,

    // Domains
    DOMAINS: (id: string) => `institutions/${id}/domains`,
    ADD_DOMAIN: (id: string) => `institutions/${id}/domains`,
    REMOVE_DOMAIN: (id: string, domainId: string) =>
      `institutions/${id}/domains/${domainId}`,
  ...
  WEBCLIP: {
    BASE: "webclips",
    CREATE: "webclips",
    START_SESSION: (contentId: string) =>
      `webclips/${contentId}/sessions/start`,
  },
} as const;
