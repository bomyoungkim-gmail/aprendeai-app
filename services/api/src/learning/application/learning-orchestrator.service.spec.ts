...
describe('LearningOrchestratorService', () => {
  ...
  beforeEach(async () => {
    ...
    service = module.get<LearningOrchestratorService>(LearningOrchestratorService);
    ...
    sessionsService = module.get<ReadingSessionsService>(ReadingSessionsService);
  });
  ...
  describe('getNextActions', () => {
    ...
    beforeEach(() => {
      ...
      mockSessionsService.getRecentSessionStats.mockResolvedValue({ doubtsCount: 0, timeSpent: 5 });
    });
