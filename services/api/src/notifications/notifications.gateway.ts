...
export class NotificationsGateway implements OnGatewayConnection, OnGatewayDisconnect {
   ...
   */
  emitContentUpdate(contentId: string, type: 'simplification' | 'assessment' | 'general') {
    const room = `content:${contentId}`;
   ...
   */
  emitContentError(contentId: string, type: 'simplification' | 'assessment', errorKey: string, message: string) {
    const room = `content:${contentId}`;
