...
export class InstitutionsController {
  ...
  @ApiResponse({ status: 200, description: 'The institution has been successfully updated.' })
  update(
    @Param('id') id: string, 
  ...
  @ApiResponse({ status: 200, description: 'The institution has been successfully deleted.' })
  ...
  getInvites(@Param('id') institutionId: string) {
    return this.inviteService.getInvites(institutionId);
  }
  ...
  getDomains(@Param('id') institutionId: string) {
    return this.domainService.getDomains(institutionId);
  }
  ...
  getPendingApprovals(@Param('id') institutionId: string) {
    return this.approvalService.getPendingApprovals(institutionId);
  }
  ...
  async processApproval(
    ...
    return this.approvalService.processApproval(approvalId, processApprovalDto, req.user.id);
  }
  ...
  async createSSOConfig(
    ...
    return this.ssoService.upsertConfig(institutionId, dto);
  }
  ...
  async deleteSSOConfig(
    ...
    return this.ssoService.deleteConfig(institutionId);
  }
