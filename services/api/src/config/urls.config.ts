...
export const URL_CONFIG = {
  ...
  oauth: {
    get google(): string {
      return process.env.GOOGLE_CALLBACK_URL || `${URL_CONFIG.api.base}/auth/google/callback`;
    },
    get microsoft(): string {
      return process.env.MICROSOFT_CALLBACK_URL || `${URL_CONFIG.api.base}/auth/microsoft/callback`;
    },
  },
