import { IsString, IsNotEmpty, IsOptional, ValidateNested, IsNumber, IsIn } from 'class-validator';
...
export class DecisionResponseDto {
  @ApiProperty({
    enum: ['NO_OP', 'SHOW_HINT', 'ASK_PROMPT', 'ASSIGN_MISSION', 'CALL_AGENT', 'GUIDED_SYNTHESIS'],
