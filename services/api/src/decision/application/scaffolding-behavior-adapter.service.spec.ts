...
describe('ScaffoldingBehaviorAdapterService', () => {
  ...
  describe('formatSystemPrompt', () => {
    it('should format L3 prompt with 4-step structure (GAP 2)', () => {
      ...
      const prompt = service.formatSystemPrompt('Base prompt', modifiers, ContentMode.DIDACTIC);
    ...
    it('should format L2 prompt with direct and verification', () => {
      ...
      const prompt = service.formatSystemPrompt('Base prompt', modifiers, ContentMode.NARRATIVE);
    ...
    it('should format L1 prompt with quick replies (GAP 7)', () => {
      ...
      const prompt = service.formatSystemPrompt('Base prompt', modifiers, ContentMode.TECHNICAL);
    ...
    it('should include tone instructions', () => {
      ...
      const promptFormal = service.formatSystemPrompt('Base', modifiersFormal, ContentMode.TECHNICAL);
      ...
      expect(promptConversational).toContain('friendly, conversational language');
    });
