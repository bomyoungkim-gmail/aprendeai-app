...
let JwtAuthGuard = JwtAuthGuard_1 = class JwtAuthGuard extends (0, passport_1.AuthGuard)("jwt") {
    ...
    handleRequest(err, user, info, context) {
        ...
        const route = `${request.method} ${request.url}`;
        if (err || !user) {
            const errorMsg = (info === null || info === void 0 ? void 0 : info.message) || (err === null || err === void 0 ? void 0 : err.message) || "Unknown auth error";
            this.logger.warn(`[AUTH_FAILED] ${route} - Reason: ${errorMsg}`);
            throw err || new common_1.UnauthorizedException(errorMsg);
        }
