...
let DeleteClassroomUseCase = class DeleteClassroomUseCase {
    ...
    async execute(id) {
        ...
        if (enrollmentCount > 0) {
            throw new common_1.BadRequestException('Cannot delete classroom with active enrollments. Remove all students first.');
        }
        await this.classroomRepo.delete(id);
    }
};
exports.DeleteClassroomUseCase = DeleteClassroomUseCase;
exports.DeleteClassroomUseCase = DeleteClassroomUseCase = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, common_1.Inject)(classroom_repository_interface_1.IClassroomRepository)),
    __metadata("design:paramtypes", [Object])
], DeleteClassroomUseCase);
//# sourceMappingURL=delete-classroom.use-case.js.map