...
exports.GetVocabListUseCase = void 0;
const common_1 = require("@nestjs/common");
const vocab_repository_interface_1 = require("../../domain/vocab.repository.interface");
let GetVocabListUseCase = class GetVocabListUseCase {
...
exports.GetVocabListUseCase = GetVocabListUseCase;
exports.GetVocabListUseCase = GetVocabListUseCase = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, common_1.Inject)(vocab_repository_interface_1.IVocabRepository)),
    __metadata("design:paramtypes", [Object])
], GetVocabListUseCase);
//# sourceMappingURL=get-vocab-list.use-case.js.map