...
export async function uploadContent(
  ...
  await page.waitForSelector('text=' + filePath.split(/[\\/]/).pop()?.substring(0, 20) || 'test');
  ...
  await page.waitForSelector('button:has-text("Fazer Upload")', { state: 'hidden', timeout: 15000 });
}
