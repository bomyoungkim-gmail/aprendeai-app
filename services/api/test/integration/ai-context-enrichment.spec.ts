...
describe('Context Enrichment', () => {
  ...
  it('should simulate last turns window (6 turns)', async () => {
    ...
    const mockEvents = [
      { role: 'user', text: 'Qual é o significado de inferir?', timestamp: new Date() },
      { role: 'assistant', text: 'Inferir significa deduzir...', timestamp: new Date() },
      ...
      { role: 'assistant', text: 'De nada! Continue assim', timestamp: new Date() },
    ];
